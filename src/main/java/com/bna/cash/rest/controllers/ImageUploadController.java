...
public class ImageUploadController {
	...
	public ResponseEntity<?> uplaodImage(@RequestBody DocumentDto file) throws IOException{
		...
		String docPath = pathToSave + File.separator + file.getName();
		FileUtils.writeByteArrayToFile(new File(docPath), file.getContent());
		img.setPath(docPath);
